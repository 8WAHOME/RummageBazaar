...
export default function Dashboard() {
  ...
  const markAsSold = async (productId, productTitle) => {
    ...
    showConfirm({
      title: "Mark as Sold",
      message: `Are you sure you want to mark "${productTitle}" as sold? This will move it to your sales history.`,
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="p-4 border-t border-gray-100">
                      <div className="flex items-center justify-between">
                        <div className="flex gap-2">
                          ...
                          {/* Mark as Sold Button */}
                          <button
                            onClick={() => markAsSold(p._id, p.title)}
                            disabled={busyId === p._id}
                        ...
                        {isAdmin && (
                          <button
                            onClick={() => removeListing(p._id, p.title)}
                            disabled={busyId === p._id}
          ...
          {soldItems.length > 0 && (
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {soldItems.map((p) => (
                  <div key={p._id} className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100 opacity-90 hover:opacity-100 transition-opacity">
                    <ProductCard item={p} />
                    <div className="p-4 border-t border-gray-100">
